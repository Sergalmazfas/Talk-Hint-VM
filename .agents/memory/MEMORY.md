...
- [Copilot private translator](copilot-private-translator-boundary.md) — Guest EN→RU + private Owner RU→EN text; no Brain in V1/V2; private intent is not spoken or auto-cancelled by Guest.
