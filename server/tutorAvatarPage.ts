...
const __lang = (navigator.language || "").toLowerCase();
const UI_LANG = __lang.startsWith("ru") ? "ru"
  : __lang.startsWith("es") ? "es"
  : __lang.startsWith("kk") ? "kk"
  : __lang.startsWith("uk") ? "uk"
  : "en";
...
DICTS.es = {
  loading: "Cargando…", connecting: "Conectando…", ready: "Mantén pulsado para hablar",
  recording: "Escuchando…", processing: "Emma está pensando…", speaking: "Emma está hablando…",
  speakingLocked: "Emma está hablando…",
  error: "Error", errorBody: "Algo salió mal. Inténtalo de nuevo.", retry: "Reintentar",
  ...
  reviewTitle: "Revisa la memoria de la llamada",
  reviewHint: "Estos datos los propone Emma: revísalos y confírmalos. Solo tras confirmarlos llegarán a las sugerencias en vivo y se usarán una vez en tu próxima llamada real.",
  objective: "Objetivo", facts: "Datos (uno por línea)", questions: "Preguntas que quieres hacer",
  answers: "Respuestas ensayadas", vocab: "Vocabulario", uncertain: "Datos no confirmados (el asistente no los afirmará)",
  confirm: "Confirmar", saving: "Guardando…",
  confirmedTitle: "Memoria de la llamada confirmada", confirmedSub: "Lista para tu llamada real",
  confirmedCnt: (n) => n + (n === 1 ? " dato confirmado" : " datos confirmados"),
  back: "Volver",
  memUnavailable: "La memoria de la llamada no está disponible.", closed: "Conexión cerrada.",
  greet: (n) => n ? ("¡Hola, " + n + "! 👋") : "¡Hola! 👋",
  greetTag: "Saludo de TalkHint — no es una respuesta de Emma",
  hintChip: "¿Qué decir?", soon: "Próximamente — requiere soporte del motor",
  hintTitle: "Sugerencia — podrías decir", noHintYet: "Aparecerá una sugerencia mientras hablas",
  teachHintTitle: "Sugerencia del profesor",
  corrTitle: "Una mejor forma de decirlo", transcribing: "Transcribiendo…",
  quitTitle: "¿Terminar la práctica?",
  quitBody: "Crearemos la memoria de la llamada con lo que dijiste: revísala y confírmala para usarla en una llamada real.",
  quitBodyEmpty: "Aún no has dicho nada. No se creará memoria de la llamada.",
  quitBodyLesson: "Esto finalizará la lección. Puedes volver a practicar cuando quieras.",
  lessonEndTitle: "Lección finalizada",
  lessonEndSub: "El resumen de tu lección está en camino: pronto verás aquí tus correcciones y palabras nuevas.",
  continueBtn: "Continuar práctica", endBtn: "Terminar",
  mMute: "Voz de Emma", mEnd: "Terminar práctica",
  mTutor: "Tutor", tutorTitle: "Elige tu tutor", tutorDone: "Listo",
  tutorApplyNext: "Se aplicará en tu próxima práctica",
  simVoiceHint: "Pulsa y di el objetivo de la llamada — los campos se rellenan solos",
  simVoiceRec: "Escuchando… pulsa de nuevo cuando termines",
  simVoiceThink: "Preparando tu simulación…",
  simVoiceNoMic: "Acceso al micrófono denegado",
  simVoiceEmpty: "No lo he captado — inténtalo de nuevo",
  on: "Sí", off: "No",
  tutorPrefix: "Tutor ",
  stLive: "En vivo", stListen: "Escuchando", stThink: "Pensando", stSpeak: "Hablando",
  composerPh: "Nuevo mensaje…",
  aPhoto: "Hacer foto", aLibrary: "Fototeca", aFile: "Adjuntar archivo", aCancel: "Cancelar",
  startTitle: "¿Cómo quieres practicar?",
  startSub: "Charla libre con Emma — o ensaya una llamada real según tu objetivo.",
  freeTalk: "Práctica libre", simTalk: "Simulación de llamada",
  simTitle: "Simulación de llamada",
  simGoalL: "Objetivo de la llamada", simGoalPh: "p. ej.: pedir cita con el médico para el viernes",
  simEmmaL: "A quién interpreta Emma (la otra parte)", simEmmaPh: "p. ej.: recepcionista de la clínica",
  simYouL: "Tu papel", simYouPh: "por defecto: quien llama",
  simMemL: "Memoria de la llamada (contexto)", simMemNone: "Sin contexto",
  simStart: "Iniciar simulación", simBack: "Atrás",
  simGoalReq: "Indica el objetivo de la llamada.", simEmmaReq: "Indica a quién interpreta Emma.",
  openingWait: "Emma está iniciando la conversación…",
  simKnows: (f,q,v) => "Emma conoce el contexto: datos " + f + ", preguntas " + q + ", vocabulario " + v,
  simTag: "Simulación — parámetros de TalkHint, las frases de Emma vienen del motor",
};
DICTS.kk = {
  loading: "Жүктелуде…", connecting: "Қосылуда…", ready: "Сөйлеу үшін басып тұрыңыз",
  recording: "Тыңдап тұрмын…", processing: "Emma ойлануда…", speaking: "Emma сөйлеп тұр…",
  speakingLocked: "Emma сөйлеп тұр…",
  error: "Қате", errorBody: "Бірдеңе дұрыс болмады. Қайталап көріңіз.", retry: "Қайталау",
  ...
  reviewTitle: "Қоңырау жадысын тексеріңіз",
  reviewHint: "Бұл деректерді Emma ұсынды — тексеріп, растаңыз. Тек расталғаннан кейін ғана олар тікелей кеңестерге түсіп, келесі нақты қоңырауда бір рет қолданылады.",
  objective: "Мақсат", facts: "Деректер (әр жолға біреуден)", questions: "Қоятын сұрақтарыңыз",
  answers: "Жаттыққан жауаптар", vocab: "Сөздік", uncertain: "Расталмаған деректер (ассистент оларды растамайды)",
  confirm: "Растау", saving: "Сақталуда…",
  confirmedTitle: "Қоңырау жадысы расталды", confirmedSub: "Нақты қоңырауға дайын",
  confirmedCnt: (n) => n + " дерек расталды",
  back: "Артқа",
  memUnavailable: "Қоңырау жадысы қолжетімсіз.", closed: "Байланыс жабылды.",
  greet: (n) => n ? ("Сәлем, " + n + "! 👋") : "Сәлем! 👋",
  greetTag: "TalkHint сәлемдесуі — Emma жауабы емес",
  hintChip: "Не айту керек?", soon: "Жақында — қозғалтқыш қолдауы қажет",
  hintTitle: "Кеңес — былай айтуға болады", noHintYet: "Сөйлескен сайын кеңес пайда болады",
  teachHintTitle: "Мұғалім кеңесі",
  corrTitle: "Қалай жақсырақ айтуға болады", transcribing: "Мәтінге түсіруде…",
  quitTitle: "Жаттығуды аяқтайсыз ба?",
  quitBody: "Айтқаныңыздан қоңырау жадысын жасаймыз — оны нақты қоңырауда қолдану үшін тексеріп, растаңыз.",
  quitBodyEmpty: "Сіз әлі ештеңе айтқан жоқсыз. Қоңырау жадысы жасалмайды.",
  quitBodyLesson: "Бұл сабақты аяқтайды. Кез келген уақытта қайта жаттыға аласыз.",
  lessonEndTitle: "Сабақ аяқталды",
  lessonEndSub: "Сабақ қорытындысы дайындалуда — жақында мұнда қателеріңіз бен жаңа сөздер шығады.",
  continueBtn: "Жаттығуды жалғастыру", endBtn: "Аяқтау",
  mMute: "Emma даусы", mEnd: "Жаттығуды аяқтау",
  mTutor: "Тәлімгер", tutorTitle: "Тәлімгеріңізді таңдаңыз", tutorDone: "Дайын",
  tutorApplyNext: "Келесі жаттығуда қолданылады",
  simVoiceHint: "Басып, қоңырау мақсатын айтыңыз — өрістер өздігінен толады",
  simVoiceRec: "Тыңдап тұрмын… аяқтаған соң қайта басыңыз",
  simVoiceThink: "Симуляция дайындалуда…",
  simVoiceNoMic: "Микрофонға рұқсат жоқ",
  simVoiceEmpty: "Естімедім — қайталап көріңіз",
  on: "Қосу", off: "Өшіру",
  tutorPrefix: "Тәлімгер ",
  stLive: "Live", stListen: "Тыңдауда", stThink: "Ойлануда", stSpeak: "Сөйлеуде",
  composerPh: "Жаңа хабарлама…",
  aPhoto: "Сурет түсіру", aLibrary: "Медиатека", aFile: "Файл тіркеу", aCancel: "Бас тарту",
  startTitle: "Қалай жаттыққыңыз келеді?",
  startSub: "Emma-мен еркін әңгіме — немесе мақсатыңыз бойынша нақты қоңырауды жаттықтырыңыз.",
  freeTalk: "Еркін жаттығу", simTalk: "Қоңырау симуляциясы",
  simTitle: "Қоңырау симуляциясы",
  simGoalL: "Әңгіме мақсаты", simGoalPh: "мысалы: жұмаға дәрігерге жазылу",
  simEmmaL: "Emma кім болады (әңгімелесуші)", simEmmaPh: "мысалы: клиника әкімшісі",
  simYouL: "Сіздің рөліңіз", simYouPh: "әдепкі: қоңырау шалушы",
  simMemL: "Қоңырау жадысы (контекст)", simMemNone: "Контекстсіз",
  simStart: "Симуляцияны бастау", simBack: "Артқа",
  simGoalReq: "Әңгіме мақсатын көрсетіңіз.", simEmmaReq: "Emma кім болатынын көрсетіңіз.",
  openingWait: "Emma әңгімені бастап жатыр…",
  simKnows: (f,q,v) => "Emma контексті біледі: деректер " + f + ", сұрақтар " + q + ", сөздік " + v,
  simTag: "Симуляция — параметрлерді TalkHint береді, Emma сөздері қозғалтқыштан",
};
DICTS.uk = {
  loading: "Завантаження…", connecting: "Підключення…", ready: "Утримуйте, щоб говорити",
  recording: "Слухаю…", processing: "Emma думає…", speaking: "Emma говорить…",
  speakingLocked: "Emma говорить…",
  error: "Помилка", errorBody: "Щось пішло не так. Спробуйте ще раз.", retry: "Повторити",
  ...
  reviewTitle: "Перевірте пам'ять розмови",
  reviewHint: "Ці факти запропонувала Emma — перевірте та підтвердіть їх. Лише після підтвердження вони потраплять у підказки й будуть використані один раз у наступному реальному дзвінку.",
  objective: "Мета", facts: "Факти (по одному в рядку)", questions: "Запитання, які ви хочете поставити",
  answers: "Відрепетирувані відповіді", vocab: "Словник", uncertain: "Неперевірені факти (асистент не стверджуватиме їх)",
  confirm: "Підтвердити", saving: "Зберігаємо…",
  confirmedTitle: "Пам'ять розмови підтверджено", confirmedSub: "Готово до реального дзвінка",
  confirmedCnt: (n) => n + " " + (n === 1 ? "факт підтверджено" : (n % 10 >= 2 && n % 10 <= 4 && (n % 100 < 10 || n % 100 >= 20) ? "факти підтверджено" : "фактів підтверджено")),
  back: "Назад",
  memUnavailable: "Пам'ять розмови недоступна.", closed: "З'єднання закрито.",
  greet: (n) => n ? ("Привіт, " + n + "! 👋") : "Привіт! 👋",
  greetTag: "Привітання TalkHint — не репліка Emma",
  hintChip: "Що сказати?", soon: "Незабаром — потрібна підтримка рушія",
  hintTitle: "Підказка — можна сказати", noHintYet: "Підказка з'явиться під час розмови",
  teachHintTitle: "Підказка вчителя",
  corrTitle: "Як сказати краще", transcribing: "Розпізнаємо…",
  quitTitle: "Завершити практику?",
  quitBody: "З ваших реплік ми створимо пам'ять розмови — перевірте й підтвердіть її, щоб використати в реальному дзвінку.",
  quitBodyEmpty: "Ви ще нічого не сказали. Пам'ять розмови не буде створено.",
  quitBodyLesson: "Заняття буде завершено. Ви можете повернутися до практики будь-коли.",
  lessonEndTitle: "Заняття завершено",
  lessonEndSub: "Підсумок заняття готується — незабаром тут з'являться ваші помилки та нові слова.",
  continueBtn: "Продовжити практику", endBtn: "Завершити",
  mMute: "Голос Emma", mEnd: "Завершити практику",
  mTutor: "Репетитор", tutorTitle: "Оберіть репетитора", tutorDone: "Готово",
  tutorApplyNext: "Застосується в наступній практиці",
  simVoiceHint: "Натисніть і скажіть мету дзвінка — поля заповняться самі",
  simVoiceRec: "Слухаю… натисніть ще раз, коли закінчите",
  simVoiceThink: "Готуємо симуляцію…",
  simVoiceNoMic: "Немає доступу до мікрофона",
  simVoiceEmpty: "Не розчула — спробуйте ще раз",
  on: "Увімк", off: "Вимк",
  tutorPrefix: "Репетитор ",
  stLive: "Live", stListen: "Слухаю", stThink: "Думає", stSpeak: "Говорить",
  composerPh: "Нове повідомлення…",
  aPhoto: "Зробити фото", aLibrary: "Медіатека", aFile: "Прикріпити файл", aCancel: "Скасувати",
  startTitle: "Як хочете практикуватися?",
  startSub: "Вільна розмова з Emma — або репетиція реального дзвінка за вашою метою.",
  freeTalk: "Вільна практика", simTalk: "Симуляція дзвінка",
  simTitle: "Симуляція дзвінка",
  simGoalL: "Мета розмови", simGoalPh: "наприклад: записатися до лікаря на п'ятницю",
  simEmmaL: "Ким буде Emma (співрозмовник)", simEmmaPh: "наприклад: адміністратор клініки",
  simYouL: "Ваша роль", simYouPh: "за замовчуванням: той, хто телефонує",
  simMemL: "Пам'ять розмови (контекст)", simMemNone: "Без контексту",
  simStart: "Почати симуляцію", simBack: "Назад",
  simGoalReq: "Вкажіть мету розмови.", simEmmaReq: "Вкажіть, ким буде Emma.",
  openingWait: "Emma починає розмову…",
  simKnows: (f,q,v) => "Emma знає контекст: факти — " + f + ", запитання — " + q + ", словник — " + v,
  simTag: "Симуляція — параметри TalkHint, репліки Emma з рушія",
};
const L = DICTS[UI_LANG] || DICTS.en;
